...
Plugin URI: https://wpgogo.com/development/lightbox-gallery.html
...
/*  Copyright 2009 -2021 Hiroaki Miyashita
...
function lightbox_gallery_wp_print_scripts() {
	...
	if ( !is_admin() && $flag ) :
		...
		if ( substr($wp_version, 0, 3) >= '5.5' ) :
			wp_enqueue_script( 'lg-jquery-migrate', '/'.PLUGINDIR.'/'.$plugin_dir.'/js/jquery-migrate-1.4.1.min.js', array('jquery'), '', $in_footer );
		endif;
